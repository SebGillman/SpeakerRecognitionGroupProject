...
class SpeedPerturbAugmentor(object):
    """
enhance by doing random voice speed
    :param min_speed_rate: new sample rate min should not be less than 0.9
    :type min_speed_rate: float
    :param max_speed_rate: new sample rate max should not be above 1.1
